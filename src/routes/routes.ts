...
const models: TsoaRoute.Models = {
  ...
  GetConfigResponse: {
    ...
    properties: {
      ...
      debug: {
        dataType: "nestedObjectLiteral",
        nestedProperties: {
          configureCaptureSettings: { dataType: "boolean", required: true },
          saveItems: {
            dataType: "nestedObjectLiteral",
            nestedProperties: {
              keywordSet: { dataType: "boolean", required: true },
            },
            required: true,
          },
          outputs: {
            dataType: "nestedObjectLiteral",
            nestedProperties: { dom: { dataType: "boolean", required: true } },
            required: true,
          },
        },
        required: true,
      ...
      config: {
        dataType: "nestedObjectLiteral",
        nestedProperties: {
          compare: { ref: "CompareInfo", required: true },
          imageCompression: {
            dataType: "nestedObjectLiteral",
            nestedProperties: {
      ...
      testSteps: {
        ...
        array: {
          ...
          nestedProperties: {
            notices: {
              dataType: "array",
              array: { dataType: "refObject", ref: "Note" },
              required: true,
            },
            bugs: {
              dataType: "array",
      ...
      coverageSources: {
        ...
        array: {
          ...
          nestedProperties: {
            screenElements: {
              dataType: "array",
              array: { dataType: "refObject", ref: "TestResultElementInfo" },
              required: true,
            },
            url: { dataType: "string", required: true },
            title: { dataType: "string", required: true },
    ...
    type: {
      ...
      subSchemas: [
        { ref: "ElementInfo" },
        {
          dataType: "nestedObjectLiteral",
          nestedProperties: {
            ownedText: { dataType: "string", required: true },
          },
        },
      ],
      validators: {},
  ...
  CapturedOperation: {
    ...
    properties: {
      ...
      screenElements: {
        dataType: "array",
        array: { dataType: "refAlias", ref: "CapturedElementInfo" },
        required: true,
      },
      inputElements: {
        dataType: "array",
  ...
  "Omit_Operation.screenElements_": {
    dataType: "refAlias",
    type: {
      ref: "Pick_Operation.Exclude_keyofOperation.screenElements__",
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  GetTestStepResponse: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        operation: { ref: "Omit_Operation.screenElements_", required: true },
        id: { dataType: "string", required: true },
      },
      validators: {},
    },
